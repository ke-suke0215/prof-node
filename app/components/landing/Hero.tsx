export function Hero() {
  return (
    <section className="relative container mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-24 flex flex-col md:flex-row items-center text-center md:text-left">
      <div className="md:w-1/2 lg:w-2/5">
        ...
        <div className="mt-8">
          <button className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 border-none cursor-pointer">
            今すぐ無料で作成
          </button>
        </div>
      </div>
      ...
      <div className="relative md:w-1/2 lg:w-3/5 mt-12 md:mt-0 flex justify-center items-center">
        <div className="relative w-full h-96">
          <div
            className="hero-card absolute w-72 h-auto bg-white/80 backdrop-filter backdrop-blur-md border border-gray-200/80 rounded-2xl shadow-lg p-6"
            style={{ transform: 'rotate(-5deg)', top: '20%', left: '10%' }}
          >
            <div className="w-16 h-16 rounded-full bg-gray-200 mx-auto mb-3"></div>
            <div className="h-5 w-3/4 bg-gray-300 rounded-md mx-auto mb-2"></div>
          ...
          <div
            className="hero-card absolute w-80 h-auto bg-white/90 backdrop-filter backdrop-blur-lg border border-gray-200 rounded-2xl shadow-2xl p-8"
            style={{ transform: 'rotate(3deg)', top: '35%', left: '35%' }}
          >
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900">Jiro Suzuki</h2>
