    ...
    <section className="relative py-12 sm:py-20 md:py-32 bg-gradient-to-br from-cyan-50 via-sky-100 to-blue-100 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="mt-6 sm:mt-8">
          <a href="/login" className="inline-block bg-blue-600 text-white font-bold py-3 px-6 sm:py-4 sm:px-10 rounded-lg text-lg sm:text-xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 border-none cursor-pointer">
            今すぐ無料で作成
          </a>
        </div>
      </div>
